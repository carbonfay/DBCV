...
class Repository(BaseModel):
    ...
    code_search_index_status: Optional[RepositoryCodeSearchIndexStatus] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of code_search_index_status
        if self.code_search_index_status:
            _dict['code_search_index_status'] = self.code_search_index_status.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "code_search_index_status": RepositoryCodeSearchIndexStatus.from_dict(obj["code_search_index_status"]) if obj.get("code_search_index_status") is not None else None
        })
        return _obj
