...
class Commit(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["url", "sha", "node_id", "html_url", "comments_url", "commit", "author", "committer", "parents", "stats", "files"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "committer": CommitAuthor.from_dict(obj["committer"]) if obj.get("committer") is not None else None,
