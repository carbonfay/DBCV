...
class Issue(BaseModel):
    ...
    parent_issue_url: Optional[StrictStr] = Field(default=None, description="URL to get the parent issue of this issue, if it is a sub-issue")
    issue_dependencies_summary: Optional[IssueDependenciesSummary] = None
    issue_field_values: Optional[List[IssueFieldValue]] = None
    __properties: ClassVar[List[str]] = ["id", "node_id", "url", "repository_url", "labels_url", "comments_url", "events_url", "html_url", "number", "state", "state_reason", "title", "body", "user", "labels", "assignee", "assignees", "milestone", "locked", "active_lock_reason", "comments", "pull_request", "closed_at", "created_at", "updated_at", "draft", "closed_by", "body_html", "body_text", "timeline_url", "type", "repository", "performed_via_github_app", "author_association", "reactions", "sub_issues_summary", "parent_issue_url", "issue_dependencies_summary", "issue_field_values"]
    ...
    def state_reason_validate_enum(cls, value):
        ...
        if value not in set(['completed', 'reopened', 'not_planned', 'duplicate']):
            raise ValueError("must be one of enum values ('completed', 'reopened', 'not_planned', 'duplicate')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if parent_issue_url (nullable) is None
        # and model_fields_set contains the field
        if self.parent_issue_url is None and "parent_issue_url" in self.model_fields_set:
            _dict['parent_issue_url'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "parent_issue_url": obj.get("parent_issue_url"),
