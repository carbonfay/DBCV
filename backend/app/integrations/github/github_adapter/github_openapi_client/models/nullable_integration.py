...
class NullableIntegration(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "owner": NullableIntegrationOwner.from_dict(obj["owner"]) if obj.get("owner") is not None else None,
            "name": obj.get("name"),
            ...
            "permissions": NullableIntegrationPermissions.from_dict(obj["permissions"]) if obj.get("permissions") is not None else None,
