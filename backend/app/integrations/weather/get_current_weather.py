"""OpenWeatherMap Get Current Weather интеграция используя httpx для прямых API вызовов."""
...
class OpenWeatherMapGetCurrentWeatherIntegration(BaseIntegration):
    """Интеграция для получения текущей погоды из OpenWeatherMap API."""

    @property
    def metadata(self) -> IntegrationMetadata:
        return IntegrationMetadata(
            id="openweathermap_get_current_weather",
            version="1.0.0",
            ...
            config_schema={
                ...
                "properties": {
                    "city": {
                        "type": "string",
                        "title": "City",
                        "description": "Название города для получения погоды (например, 'London', 'Moscow')"
                    },
                    "units": {
                        "type": "string",
                        "title": "Units",
            ...
            examples=[
                {
                    "title": "Получить текущую погоду в Москве",
                    "config": {
                        "city": "Moscow, RU",
                        "units": "metric"
                    }
                ...
                {
                    "title": "Получить текущую погоду в Нью-Йорке в Фаренгейтах",
                    "config": {
                        "city": "New York",
                        "units": "imperial"
                    }
